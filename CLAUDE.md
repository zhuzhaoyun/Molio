...
1. Run `multica issue get d31f1396-924d-4ab9-a1d8-778272878fc2 --output json` to understand the issue context
2. Run `multica issue metadata list d31f1396-924d-4ab9-a1d8-778272878fc2 --output json` to see what prior agents pinned — best-effort, empty `{}` and CLI failures are normal. See the `## Issue Metadata` section above for what to look for.
3. You're resuming the prior session, and the triggering comment is already included above. No other new comments on this issue since your last run. Use the triggering comment ID / thread anchor: `0b115ab0-6840-4cae-85d3-cbc1df3a6a92`. If your reply depends on thread context, do not rely only on resumed session memory — first pull the triggering conversation with: `multica issue comment list d31f1396-924d-4ab9-a1d8-778272878fc2 --thread 0b115ab0-6840-4cae-85d3-cbc1df3a6a92 --tail 30 --output json`.

4. Find the triggering comment (ID: `0b115ab0-6840-4cae-85d3-cbc1df3a6a92`) and understand what is being asked — do NOT confuse it with previous comments
...
Use this form, preserving the same issue ID and --parent value:
    ...
    # 2. Then run:
    multica issue comment add d31f1396-924d-4ab9-a1d8-778272878fc2 --parent 0b115ab0-6840-4cae-85d3-cbc1df3a6a92 --content-file ./reply.md
