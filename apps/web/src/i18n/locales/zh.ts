const zh: Record<string, string> = {
  ...
  'publish.priceHint': '管理员定价；付费资源须同时填写下方外部支付链接',
  'publish.nonAdminPriceValue': '0',
  'publish.nonAdminPrice': '非管理员默认 ¥0（仅官方账号可定价）',
  'publish.payUrl': '外部支付链接',
  'publish.payUrlPlaceholder': 'https://…',
  'publish.payUrlHint': '买家点击「购买」将跳到此页面付款',
  'publish.error.priceInvalid': '请输入有效价格',
  'publish.error.payUrlRequired': '定价资源须填写外部支付链接',
  'myListings.view': '查看',
