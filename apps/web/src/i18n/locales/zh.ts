const zh: Record<string, string> = {
  ...
  'graph.nodes.title': '当前画布节点数',
  'graph.edges': '{count} 条链接',
  'graph.selectVault': '选择知识库',
  'graph.empty': '该知识库中没有 Markdown 文件',
  'graph.truncated': '节点较多，已显示连接最多的节点，用搜索定位其余节点',
  'graph.search.placeholder': '搜索节点',
  'graph.search.empty': '无匹配节点',
  'graph.ego.focus': '聚焦：{label}',
  'graph.ego.exit': '返回全图',
  'graph.card.open': '打开文档',
  'graph.card.focus': '聚焦',
  'graph.card.bloom': '展开邻居',
  'graph.card.links': '{count} 个链接',
  'graph.card.dead': '未解析的 wikilink',
