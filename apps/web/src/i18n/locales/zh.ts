const zh: Record<string, string> = {
  ...
  'kb.vaultSkills': '技能配置',
  'kb.vaultSkillsTitle': '知识库技能',
  'kb.vaultSkillsDesc': '全局启用的技能默认在本知识库生效，可在此单独关闭；已全局禁用的技能不可开启。',
  'kb.vaultSkillsGlobalOff': '已全局禁用',
  'kb.vaultSkillsEmpty': '技能库还没有技能，可先到「设置 → 技能」新建或导入。',
