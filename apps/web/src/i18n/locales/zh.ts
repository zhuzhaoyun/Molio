const zh: Record<string, string> = {
  ...
  'skills.form.importModeRaw': '粘贴 SKILL.md 原文',
  'skills.form.importModeFolder': '本地文件夹路径',
  'skills.form.rawPlaceholder': '---\nname: …\ndescription: …\n---\n\n指令正文',
  'skills.form.folderPlaceholder': '例如：D:\\skills\\my-skill',
