const zh: Record<string, string> = {
  ...
  'channels.feishu.wizard.step5.title': '5. 发布版本并审批',
  'channels.feishu.wizard.step5.desc': '在「版本管理与发布」页创建版本并提交审核，企业管理员审批通过后应用才能收发消息。',
  'channels.feishu.wizard.step6.title': '6. 选择默认运行时',
  'channels.feishu.wizard.step6.desc': '在下方选择消息默认使用的 agent 运行时。',
  'channels.feishu.wizard.step7.title': '7. 启动连接',
  'channels.feishu.wizard.step7.desc': '保存凭证后点击「启动连接」，Molio 会通过 WebSocket 与飞书建立长连接。',
