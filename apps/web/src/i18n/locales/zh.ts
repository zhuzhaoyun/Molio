const zh: Record<string, string> = {
  ...
  'composer.placeholder': '输入消息… @ 引用文件 · / 调用技能',
  'composer.stop': '停止',
  'composer.send': '发送',
  'composer.hint': 'Shift+Enter 换行',
  'composer.hintFileRef': '引用文件/目录',
  'composer.hintSkill': '调用技能',
  'composer.skillPrefix': '用 {name} skill ',
  'skillPalette.loading': '加载技能中…',
  'skillPalette.loadError': '技能加载失败',
  'skillPalette.empty': '暂无可用技能 — 可在 设置 → 技能 中创建，或到技能商店安装',
  'skillPalette.bundled': '内置',
  ...
  'composer.modelMenu': '模型与运行时',
  'composer.modelGroup': '模型',
  'composer.runtimeGroup': '运行时',
  ...
  'history.filter.currentVault': '当前知识库',
  ...
  'history.emptyScoped': '当前知识库暂无会话',
  'history.viewAll': '查看全部会话',
  ...
  'filePicker.root': '根',
  'filePicker.referenceFolder': '引用此目录（Shift+Enter）',
  'filePicker.clearSearch': '清除搜索',
  'filePicker.hint': '↑↓ 选择 · Enter 进入目录 · Shift+Enter 引用此目录 · Esc 返回/关闭',
