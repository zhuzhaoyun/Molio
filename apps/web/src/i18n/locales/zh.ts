const zh: Record<string, string> = {
  ...
  'account.loginHeadline': '登录你的 Molio 账号',
  'account.loginBenefit1': '免费下载精选资源，更新自动送达',
  'account.loginBenefit2': '资源一键分享，创作随处可用',
  'account.loginBenefit3': '知识库与创作多设备同步（即将上线）',
  'account.loginBenefit4': '更个性化的推荐与服务',
  'account.loginFootnote': '不登录也能用。所有本地功能',
  'account.loginIntro': '用邮箱登录或注册，30 秒完成',
