const en: Record<string, string> = {
  ...
  'graph.nodes.title': 'Nodes on the current canvas',
  'graph.edges': '{count} edges',
  'graph.selectVault': 'Select vault',
  'graph.empty': 'No Markdown files in this vault',
  'graph.truncated': 'Large graph: showing the most connected nodes. Use search to locate the rest.',
  'graph.search.placeholder': 'Search nodes',
  'graph.search.empty': 'No matching nodes',
  'graph.ego.focus': 'Focus: {label}',
  'graph.ego.exit': 'Back to full graph',
  'graph.card.open': 'Open doc',
  'graph.card.focus': 'Focus',
  'graph.card.bloom': 'Expand',
  'graph.card.links': '{count} links',
  'graph.card.dead': 'Unresolved wikilink',
