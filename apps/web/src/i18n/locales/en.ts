const en: Record<string, string> = {
  ...
  'channels.feishu.wizard.step5.title': '5. Publish a version and get approval',
  'channels.feishu.wizard.step5.desc': 'On the "Version Management & Release" page, create a version and submit it for review. The app can only send/receive messages after an enterprise admin approves it.',
  ...
  'channels.feishu.wizard.step7.title': '7. Start the connection',
  'channels.feishu.wizard.step7.desc': 'After saving credentials, click "Start connection". Molio will establish a WebSocket long connection with Feishu.',
