const en: Record<string, string> = {
  ...
  'composer.placeholder': 'Ask anything… @ to reference · / for skills',
  'composer.stop': 'Stop',
  'composer.send': 'Send',
  'composer.skillPrefix': 'Use the {name} skill to ',
  'skillPalette.loading': 'Loading skills…',
  'skillPalette.loadError': 'Failed to load skills',
  'skillPalette.empty': 'No skills installed — create one in Settings → Skills or install from the Skill Hub',
  'skillPalette.bundled': 'Built-in',
  ...
  'composer.modelMenu': 'Model & runtime',
  ...
  'history.filter.currentVault': 'This vault',
  ...
  'history.emptyScoped': 'No conversations in this vault yet',
  'history.viewAll': 'View all conversations',
  ...
  'graph.deadLinks': '{count} dead link(s)',
  'graph.searchNodes': 'Search nodes',
  'graph.stats': 'Node stats',
  ...
  'kb.newTab': 'New tab',
  'kb.pinTab': 'Pin tab',
  'kb.splitGraph': 'Graph beside',
  'kb.splitFile': 'File beside…',
  'kb.splitCopy': 'Split right',
  ...
  'filePicker.referenceFolder': 'Reference this folder (Shift+Enter)',
