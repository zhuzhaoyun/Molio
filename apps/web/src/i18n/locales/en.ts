const en: Record<string, string> = {
  ...
  'publish.priceHint': 'Admin-priced; paid listings also require the external payment link below',
  'publish.nonAdminPriceValue': '0',
  'publish.nonAdminPrice': 'Fixed at ¥0 for non-admins (admin accounts can price)',
  'publish.payUrl': 'External payment URL',
  'publish.payUrlPlaceholder': 'https://…',
  'publish.payUrlHint': 'Buyers are redirected here after clicking Buy',
  'publish.error.priceInvalid': 'Enter a valid price',
  'publish.error.payUrlRequired': 'Paid listings require a payment URL',
