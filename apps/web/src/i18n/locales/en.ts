const en: Record<string, string> = {
  ...
  'account.loginHeadline': 'Sign in to your Molio account',
  'account.loginBenefit1': 'Download free resources, get updates automatically',
  'account.loginBenefit2': 'Share resources in one click, use your work anywhere',
  'account.loginBenefit3': 'Sync knowledge base and works across devices (coming soon)',
  'account.loginBenefit4': 'More personalized recommendations and services',
  'account.loginFootnote': 'All local features work without signing in',
  'account.loginIntro': 'Sign in or register with just an email — it takes 30 seconds',
