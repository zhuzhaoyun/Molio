interface Props {
  activeView: 'home' | 'knowledge' | 'runtimes' | 'settings';
  onViewChange: (view: 'home' | 'knowledge' | 'runtimes' | 'settings') => void;
}
  ...
  return (
    <nav className="entry-nav-rail">
      ...
      <div className="entry-nav-rail__group">
        <button
          type="button"
          className={`entry-nav-rail__btn ${activeView === 'settings' ? 'is-active' : ''}`}
