...
<p align="center">
  <img src="docs/img/main.png" alt="首页" width="100%" />
  <br/>
  <sup>首页：AI 对话界面，选择 Agent 发送消息，支持流式响应</sup>
</p>

<p align="center">
  <img src="docs/img/wiki_knowledge.png" alt="知识库" width="100%" />
  <br/>
  <sup>知识库：Vault 文件树管理，Markdown 渲染与浏览</sup>
</p>

<p align="center">
  <img src="docs/img/Layout%20.png" alt="排版编辑器" width="100%" />
  <br/>
  <sup>排版编辑器：左右分栏实时预览，支持主题、字体、颜色等样式调整</sup>
</p>

<p align="center">
  <img src="docs/img/publish.png" alt="多平台发布" width="100%" />
  <br/>
  <sup>多平台发布：一键同步到 30+ 内容平台</sup>
</p>
